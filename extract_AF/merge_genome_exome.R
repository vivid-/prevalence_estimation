...
colnames(genome) <- c("CHROM","POS","ID.genome","REF","ALT","QUAL.genome","FILTER.genome","Allele.Count.genome","Allele.Number.genome","Allele.Frequency.genome","AC_FIN.genome","AC_NFE.genome","AC_ASJ.genome","AC_AFR.genome","AC_EAS.genome","AN_FIN.genome","AN_NFE.genome","AN_ASJ.genome","AN_AFR.genome","AN_EAS.genome","Annotation.genome")
colnames(exome) <- c("CHROM","POS","ID.exome","REF","ALT","QUAL.exome","FILTER.exome","Allele.Count.exome","Allele.Number.exome","Allele.Frequency.exome","AC_FIN.exome","AC_NFE.exome","AC_ASJ.exome","AC_AFR.exome","AC_EAS.exome","AN_FIN.exome","AN_NFE.exome","AN_ASJ.exome","AN_AFR.exome","AN_EAS.exome","Annotation.exome")
